# Source: https://wwwf.imperial.ac.uk/~gmontana/software/grv/GRV_test.R
...
#' @param GX,GY  Two GRV matrices of identical dimensions.
#' @param y ...
#' 
#' @rdname GRV.test
...
#' Generalised RV (GRV) test
#'
#' The GRV statistic allows to compare two paired distance matrices.
#'
#' @param DX,DY  Two numeric matrices of identical dimensions to be compared.
#'
#' @example incl/example.R
#'
#' @references
